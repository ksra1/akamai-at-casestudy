...
const deliveryProducts = [
  ...
  { icon: Code2, label: "EdgeWorkers", desc: "Serverless compute at the Akamai edge. Run JavaScript/TypeScript for custom logic without origin round-trips. Key use cases: microservices traffic routing during monolith-to-microservices migration, personalized queue/waiting room pages during 5x traffic spikes, custom bot challenge injection (CAPTCHAs, proof-of-work) on high-risk API endpoints, and request transformation for API contract mapping." },
        ...
        <div className="clean-card p-4 md:p-6">
          ...
          <div className="block md:hidden space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  { icon: Server, label: "On-Prem", sub: "Legacy/ Monolith" },
                  { icon: Cloud, label: "AWS", sub: "Microservices" },
                  { icon: Layers, label: "On-Prem", sub: "Modern" },
                ].map(({ icon: Icon, label, sub }) => (
