...
const pillars = [
  {
    ...
    color: "bg-primary",
    outcomes: [
      "5,000 hostnames onboarded in 30 days",
      "5x traffic capacity via Ion + GTM",
      "50-70% image optimization via IVM",
      "Automated via Terraform & Bulk API",
    ],
  },
  {
    icon: Shield,
    ...
    outcomes: [
      ...
      "Behavioral bot detection stops evasion",
      "Adaptive WAF auto-tunes, 5x fewer false positives",
      "Origin fully shielded from direct attacks",
    ],
  },
  {
    icon: Globe,
    ...
    outcomes: [
      ...
      "Canary deployments mitigate no-testing risk",
    ...
    <SlideLayout id="summary" variant="navy">
      <div className="flex flex-col items-center justify-center space-y-10 min-h-[70vh]">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-primary-foreground/50 text-lg">Questions & Discussion</p>
        </div>

        <button
          onClick={() => setGlossaryOpen(true)}
          className="callout-badge flex items-center gap-2 bg-primary/20 text-primary px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-primary/30 transition-colors no-print"
        >
